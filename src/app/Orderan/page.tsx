...
const Orderan: FunctionComponent = () => {
	const onTambahProdukTextClick = useCallback(() => {
		// Add your code here
	}, []);
	const onOrderanTextClick = useCallback(() => {
		// Add your code here
	}, []);
	const onKonfirmasiTextClick = useCallback(() => {
		// Add your code here
	}, []);
	const onBatalkanTextClick = useCallback(() => {
		// Add your code here
	}
		, []);

	return (
		<div className={styles.orderan}>
			...
			<Image className={styles.icon} alt="" src={hijau} />
			<Image className={styles.icon1} alt="" src={merah} />
			<Image className={styles.icon2} alt="" src={orange} />
			...
			<Image className={styles.icon3} alt="" src={hijau2} />
			...
			<Image className={styles.icon4} alt="" src={biru} />
			...
			<div className={styles.orderanChild3} />
			<b className={styles.alkesCom}>ALKES .COM</b>
			<Image className={styles.icon5} alt="" src={profiladmin} />
			<Link href="/TambahProduk">
			<div className={styles.tambahProduk} onClick={onTambahProdukTextClick}>Tambah Produk</div>
			</Link>
			...
			<div className={styles.orderan2} onClick={onOrderanTextClick}>Orderan</div>
