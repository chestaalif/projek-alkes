...
const TambahProduk:FunctionComponent = () => {
	const onOrderanTextClick = useCallback(() => {
		// Add your code here
		}, []);
	return (
		<div className={styles.tambahProduk}>
			...
			<Image className={styles.icon1} alt="" src={kanan} />
			<Image className={styles.icon2} alt="" src={kiri} />
			...
			<Image className={styles.icon3} alt="" src={search} />
			...
			<Link href="/Orderan"> 
			<div className={styles.orderan} onClick={onOrderanTextClick}>Orderan</div>
			</Link>
			...
			<div className={styles.alatCek3In1NescoParent}>
				...
				<Image className={styles.icon4} alt="" src={icon5} />
			...
			<Link href="/EditProduk"> 
				<div className={styles.rectangleParent3} onClick={onOrderanTextClick}>
					<div className={styles.groupChild2} />					
					<div className={styles.editProduk}>edit produk</div>
				</div>
				</Link>
				<Link href="/EditProduk"> 
				<div className={styles.rectangleParent4} onClick={onOrderanTextClick}>
					<div className={styles.groupChild2} />
					<div className={styles.editProduk}>edit produk</div>
				</div>
				</Link>
				<Link href="/EditProduk"> 
				<div className={styles.rectangleParent5} onClick={onOrderanTextClick}>
					<div className={styles.groupChild2} />
					<div className={styles.editProduk}>edit produk</div>
				</div>
				</Link>
			</div>
			<Image className={styles.icon5} alt="" src={icon5} />
			<Image className={styles.whatsappImage20250109At11} alt="" src={icon6} />
			<div className={styles.component3}>
				<Image className={styles.icon6} alt="" src={profiladmin} />
				<div className={styles.iniadmin}>iniadmin</div>
				<Image className={styles.icon7} alt="" src={kebawah} />
			</div>
			<div className={styles.tambahProdukInner1} onClick={onOrderanTextClick}>
			<Link href="/EditProduk"> 
				<div className={styles.rectangleParent6} onClick={onOrderanTextClick}>
					<div className={styles.groupChild2} />
					<div className={styles.editProduk}>edit produk</div>
				</div>
			</Link>
			...
			<Link href="/EditProduk"> 
			<div className={styles.rectangleParent1} onClick={onOrderanTextClick}>
				<div className={styles.groupChild2} />
				<div className={styles.editProduk}>edit produk</div>
			</div>
			</Link>
			<Link href="/TambahProdukuuk">
			<div className={styles.rectangleParent7} onClick={onOrderanTextClick}>
